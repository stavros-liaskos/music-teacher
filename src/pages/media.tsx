      ...
      <section>
        ...
        <div className='flex flex-col justify-center gap-8 pb-16 md:flex-row'>
          ...
          <div className='flex flex-col justify-center gap-4'>
            <p>
              Ο στόχος είναι τα παιδιά να γνωρίσουν τον κόσμο της μουσικής με
              βιωματικό τροπο. <b>Ντύνοντας το Σκουληκάκι</b>
              (τραγούδι βασισμένο στο “Βαλς των λουλουδιών” του Τσαϊκόφσκι), τα
              παιδιά αναπτύσσουν την λεπτή τους κινητικότητα και εξασκούνται
              στον συντονισμό ματιού-χεριού. Μέσω της μίμησης του συνόδου,
              μπορούν πιο εύκολα να εισαχθούν στο κόσμο της μουσικής.
            </p>
            <span className='flex justify-end'>Παιδιά 2 ετών</span>
          </div>
        </div>
        ...
        <div className='flex flex-col justify-center gap-8 pb-16 md:flex-row'>
          ...
          <div className='flex flex-col justify-center gap-4'>
            <p className='flex items-center'>
              Δουλεύοντας τις ποιότητες της κίνησης μέσω παιχνιδιού.
            </p>
            <span className='flex justify-end'>Παιδιά 8 ετών</span>
          </div>
        </div>
      </section>
    </Layout>
